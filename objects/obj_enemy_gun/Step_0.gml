...
x_startup_offset_support = lerp(0,x_startup_offset_support,gun_lerp);
x_startup_offset_cannon = lerp(0,x_startup_offset_cannon,gun_lerp);
...
obj_sensor.image_xscale = length_laser/laser_startup;
	...
	*/
	...
	repeat(image_xscale){
		if(position_meeting(x+dir_x,y+dir_y,obj_player)) and (!other.get_out){
			DamageTaken(other.gun_damage,false,15);
			repeat(5){
