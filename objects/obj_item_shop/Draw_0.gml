...
draw_text_ext_color(x,y+(sprite_height/2),string(global.items_array[random_item][1]),text_height,sprite_width*3,draw_get_color(),draw_get_color(),draw_get_color(),draw_get_color(),alpha);
